        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    ...
                    @foreach($ds_aothunnam as $ds_aothunnam)
                    <div class="col-lg-4 col-md-6">
                        @if($ds_aothunnam->km_giatriphantram == 0)
                        <div class="product__item"  style="border: solid 1px whitesmoke;">
                            <div class="product__item__pic set-bg" data-setbg="{{ asset('storage/photos/' . $ds_aothunnam->ha_ten) }}">
                                <ul class="product__hover">
                                    <li><a href="{{ asset('storage/photos/' . $ds_aothunnam->ha_ten) }}" class="image-popup"><span
                                                class="arrow_expand"></span></a></li>
                                    <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                    <li><a href="{{ route('frontend.sanpham.xemchitiet', ['sp_id' => $ds_aothunnam->sp_id]) }}"><span class="icon_search"></span></a></li>
                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a href="{{ route('frontend.sanpham.xemchitiet', ['sp_id' => $ds_aothunnam->sp_id]) }}">{{ $ds_aothunnam->sp_ten }}</a></h6>
                                <!-- <div class="rating">
                                ...
                                <div class="product__price mt-1">{{ number_format($ds_aothunnam->sp_giaban, 0, ',' , ',') }} đ</div>
                            </div>
                        </div>
                        @else
                        <div class="product__item sale"  style="border: solid 1px whitesmoke;">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__price mt-1">{{ number_format($ds_aothunnam->sp_giaban - ($ds_aothunnam->sp_giaban * $ds_aothunnam->km_giatriphantram/100),0, ',' , ',') }} đ&nbsp;<span>{{ number_format($ds_aothunnam->sp_giaban, 0, ',' , ',') }} đ</span></div>
                            </div>
                        </div>
                        @endif
                    </div>
