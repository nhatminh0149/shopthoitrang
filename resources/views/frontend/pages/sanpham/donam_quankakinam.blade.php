                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__price mt-1">{{ number_format($ds_quankakinam->giaban, 0, ',' , ',') }} đ</div>
                            </div>
                        </div>
                        @else
                        <div class="product__item sale">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__price mt-1">{{ number_format($ds_quankakinam->giaban - ($ds_quankakinam->giaban * $ds_quankakinam->km_giatriphantram/100),0, ',' , ',') }} đ&nbsp;<span>{{ number_format($ds_quankakinam->giaban, 0, ',' , ',') }} đ</span></div>
                            </div>
                        </div>
                        @endif
                    </div>
