                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table" id="order-listing">
                                ...
                                <tbody>
                                    @foreach ($ds_pnk as $ds_pnk)   
                                    <tr>
                                        <?php 
                                            $pnk_ngaynhapkho=date("d-m-Y", strtotime($ds_pnk->pnk_ngaynhapkho));
                                        ?>
                                        <td class="text-center" style="width: 10px;">{{ $ds_pnk->pnk_id }}</td>
                                        <td style="width: 150px;">{{ $ds_pnk->admin->name }}</td>
