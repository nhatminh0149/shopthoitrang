            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <form class="mt-4 ml-5 mr-5 mb-5" role="form" action="{{ route('admin.sp.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    Mô tả sản phẩm:<input type="text" class="form-control" id="sp_mota" name="sp_mota" value="{{ old('sp_mota') }}">
