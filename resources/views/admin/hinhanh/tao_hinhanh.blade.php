                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">THÊM MỚI HÌNH ẢNH SẢN PHẨM</h4>
                            <!-- <p class="card-category"> Here is a subtitle for this table</p> -->
                        </div>

                        <form class="mt-4 ml-5 mr-5 mb-5" role="form" action="{{ route('admin.hinhanh.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <button type="submit" class="btn btn-outline-primary">Thêm hình ảnh sản phẩm mới</button>
                        </form>
