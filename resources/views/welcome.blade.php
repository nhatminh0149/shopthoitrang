        ...
        <div class="row property__gallery">
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-1.jpg') }}">
                        <div class="label new">New</div>
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-1.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-2.jpg') }}">
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-2.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-3.jpg') }}">
                        <div class="label stockout">out of stock</div>
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-3.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-4.jpg') }}">
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-4.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-5.jpg') }}">
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-5.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-6.jpg') }}">
                        <div class="label sale">Sale</div>
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-6.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-7.jpg') }}">
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-7.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('ashion/img/product/product-8.jpg') }}">
                        <div class="label">Sale</div>
                        <ul class="product__hover">
                            <li><a href="{{ asset('ashion/img/product/product-8.jpg') }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <div class="footer__payment">
                        ...
                        <a href="#"><img src="{{ asset('ashion/img/payment/payment-3.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('ashion/img/payment/payment-4.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('ashion/img/payment/payment-5.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
